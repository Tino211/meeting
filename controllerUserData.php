...
if(isset($_POST['signup'])){
    ...
    if(count($errors) === 0){
        ...
        $status = "notverified";
        $insert_data = "INSERT INTO usertable (name, phonenumber, email, password, code, status)
                        values('$name', '$email','$phonenumber' '$encpass', '$code', '$status')";
        $data_check = mysqli_query($con, $insert_data);
        if($data_check){
            $subject = "Email Verification Code";
            $message = "Your verification code is $code";
            $sender = "From: tinotendakatso@gmail.com";
